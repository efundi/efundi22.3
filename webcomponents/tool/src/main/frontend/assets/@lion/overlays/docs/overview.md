...
See [lion-dialog](../../../components/interaction/dialog/overview.md) and [lion-tooltip](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/components/interaction/tooltip/overview.md) for example Web Component implementations using the Overlay System.
...
- [**OverlaysManager**](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/docs/systems/overlays/features.md#overlaysmanager), a global repository keeping track of all different types of overlays
- [**OverlayController**](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/docs/systems/overlays/features.md#overlaycontroller), a single controller class for handling overlays
- [**OverlayMixin**](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/docs/systems/overlays/features.md#overlaymixin), a mixin that can be used to create webcomponents that use the OverlayController under the hood
...
Please check the [system rationals](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/docs/systems/overlays/rationale.md) folder, where we go more in-depth.
