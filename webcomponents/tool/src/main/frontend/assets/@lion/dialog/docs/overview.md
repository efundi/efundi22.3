...
The documentation of the full config object can be found in the `lion/overlay` package or here in [Overlay System - Configuration](https://github.com/ing-bank/lion/blob/5d08951f429f7756c7ed56cf505151d7f53a7af4/docs/docs/systems/overlays/configuration.md).
