...
//			}
			...
			if (lesson.getAction() != null && lesson.getAction().equals(Constants.CREATE)) {
				createAssignment(lessonDao, course, lesson, Constants.CREATE);
			} else if (lesson.getAction() != null && lesson.getAction().equals(Constants.UPDATE)) {
				updateAssignment(lessonDao, course, lesson, Constants.UPDATE, currentUserId);
			} else if (lesson.getAction() != null && lesson.getAction().equals(Constants.DELETE)) {
