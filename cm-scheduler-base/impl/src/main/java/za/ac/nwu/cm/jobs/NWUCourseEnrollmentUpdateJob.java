...
/**
 * This is a quartz job that will update Course sites with enrolled
 * (adding/removing) Students data.
 * 
 * @author JC Gillman
 * 
 */
...
public class NWUCourseEnrollmentUpdateJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			getService().updateNWUCourseEnrollments(previousFireTime == null ? null : previousFireTime);
		} catch (JobExecutionException e) {
			throw new JobExecutionException("NWUCourseEnrollmentUpdateJob failed");
		}
