...
//				securityService.pushAdvisor(yesMan);
				...
				for (NWUCourse course : courses) {
					...
					if(course.getAction().equals(Constants.CREATE) && course.getEfundiSiteId() == null) {
					...
					} else if (course.getAction().equals(Constants.UPDATE) && course.getEfundiSiteId() != null) {
					...
					} else if (course.getAction().equals(Constants.DELETE) && course.getEfundiSiteId() != null) {
